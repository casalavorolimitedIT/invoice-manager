...
import { getInvoiceStats, getInvoices } from "@/lib/supabase/invoices";
...
import { DashboardInfoButton } from "./_components/dashboard-info-button";
import { RecentInvoiceActivityTable } from "./_components/recent-invoice-activity-table";
...
export default async function DashboardPage() {
  ...
  const [stats, clients, recentInvoices] = await Promise.all([
  ...
  const averageInvoiceValue = stats && stats.count > 0 ? stats.total / stats.count : 0;
      ...
      <div className="space-y-6 p-4 md:p-6">
          ...
          <div className="relative grid gap-6 xl:grid-cols-[1.15fr_0.85fr] xl:items-end">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-xl text-sm leading-6 text-zinc-600 md:text-base">
                  {stats?.count ?? 0} invoices, {clients.length} clients, and {formatPercent(collectionRate)} collected.
                </p>
              </div>
              <div className="flex flex-wrap gap-3">
                <Button render={<Link href="/dashboard/invoices/new" />}>Create invoice</Button>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <OverviewCard
                ...
                sub={formatCurrency(stats?.paid ?? 0, currency)}
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          {/* <OverviewCard
            ...
            sub={`${businessUnits.length} business units in workspace`}
            icon={<HugeiconsIcon icon={UserGroupIcon} strokeWidth={2} className="size-4 text-orange-600" />}
        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="mt-5 rounded-[22px] border border-zinc-200 bg-white/80 p-4">
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold text-zinc-950">{stats?.draftCount ?? 0}</p>
                </div>
                <div>
          ...
          <section className="rounded-[28px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(252,250,247,0.9)_100%)] p-5 shadow-[0_22px_70px_rgba(24,18,9,0.06)] md:p-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              label="Invoices"
              description={`${stats?.count ?? 0} total invoices`}
