...
function OverviewCard({
  ...
  return (
    <div className="rounded-[24px] border border-white/80 bg-white/88 p-5 shadow-[0_18px_50px_rgba(24,18,9,0.06)]">
      ...
      <div className={cn(
        "mt-4 text-2xl font-semibold tracking-[-0.04em] text-zinc-950",
        isOpen && "blur-lg"
      )}>
        {value}
      </div>
      {sub && <div className={cn("mt-2 text-sm text-zinc-600", isOpen && "blur-lg")}>{sub}</div>}
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <HugeiconsIcon
        ...
        strokeWidth={2}
        className="size-4 text-zinc-400 transition-colors group-hover:text-primary"
      />
    </Link>
  );
}
          ...
          <>
            ...
            {canCreateInvoice ? (
              <Button
                ...
                className="shadow-sm"
                render={
                  <Link href="/dashboard/invoices/new" className="gap-1.5" />
                }
              >
                <HugeiconsIcon
          ...
          <div className="relative grid gap-6 xl:grid-cols-[1.15fr_0.85fr] xl:items-end">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-xl text-sm leading-6 text-zinc-600 md:text-base">
                  {stats.count} invoices, {clientsCount} clients, and{" "}
            ...
            <div className="flex flex-col lg:items-end">
              <button
                ...
                title="Toggle Amount"
                aria-label={isOpen ? "Show dashboard total" : "Hide dashboard total"}
                className="relative bottom-7.5 inline-flex cursor-pointer items-center gap-2 rounded-full border border-orange-200/80 bg-white/75 p-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-orange-700 shadow-sm"
              >
                <HugeiconsIcon
            ...
            <div className="mb-5 flex items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-600">
                  The most useful next actions for this workspace.
                </p>
              </div>
          ...
          <section className="rounded-[28px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(252,250,247,0.9)_100%)] p-5 shadow-[0_22px_70px_rgba(24,18,9,0.06)] md:p-6">
            <div className="mb-5 flex items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-600">
                  Move between the core parts of the app faster.
                </p>
              </div>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
        ...
        <section className="rounded-[28px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(252,249,246,0.9)_100%)] p-5 shadow-[0_22px_70px_rgba(24,18,9,0.06)] md:p-6">
          <div className="mb-5 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-600">
                Latest invoices in the current scope.
              </p>
            </div>
            <Button
              variant="outline"
        ...
        {businessUnits.length === 0 && (
          <div className="rounded-[28px] border border-dashed border-zinc-300 bg-white/70 p-10 text-center shadow-[0_12px_40px_rgba(24,18,9,0.03)]">
            ...
            <Button
              className="mt-4"
              size="sm"
              render={<Link href="/dashboard/business-units/new" />}
            >
